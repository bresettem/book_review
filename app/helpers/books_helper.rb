module BooksHelper
  #From https://www.toptal.com/ruby-on-rails/rails-helper-bootstrap-carousel
  ...
  #   def indicators
  #     items = images.(Book.count).times.map { |index| indicator_tag(index) }
